...
Before publishing an `ERROR` diagnostic, a collision must be detected for at least a duration set by the parameter `time_buffer.on_duration`.
...
To stop publishing the `ERROR` diagnostic, no collision must be detected for at least a duration set by the parameter `time_buffer.off_duration`.
...
| `time_buffer.on_duration`             | `double`                | [s] minimum consecutive detection time before triggering the ERROR diagnostic                                                                                                                                                                                                                                                                  | 0.2                                                                                                                                        |
| `time_buffer.off_duration`            | `double`                | [s] minimum consecutive time without collision detection (including the hysteresis) before releasing the ERROR diagnostic                                                                                                                                                                                                                      | 5.0                                                                                                                                        |
